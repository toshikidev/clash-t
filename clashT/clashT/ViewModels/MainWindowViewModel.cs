...
namespace clashT.ViewModels
{
    public class MainWindowViewModel : ReactiveObject
    {
        ...
        private void Init()
        {
            ...
            {
                UI.ShowWarning($"Loading GUI configuration file is abnormal,please restart the application{Environment.NewLine}����GUI�����ļ��쳣,������Ӧ��");
                Environment.Exit(0);
                return;
            }
